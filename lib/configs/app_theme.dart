...
class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: const Color.fromARGB(255, 2, 44, 231).withAlpha(100),
    primary: const Color.fromARGB(255, 2, 44, 231),
    primaryLight: const Color.fromARGB(255, 2, 44, 231).withAlpha(100),
